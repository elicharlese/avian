      ...
      <section className="w-full bg-background py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            ...
            <div className="h-[400px] overflow-hidden rounded-xl bg-gradient-to-br from-primary/80 via-sky-500/70 to-slate-900" />
          </div>
        </div>
      </section>
...
function TeamMember({
  ...
  return (
    <div className="flex flex-col items-center text-center">
      <div className="mb-4 h-48 w-48 rounded-full bg-gradient-to-br from-primary/80 via-sky-500/70 to-slate-900" />
